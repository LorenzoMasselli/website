...
function Home() {
    ...
    useEffect(() => {
      ...
      const handleScroll = () => {
        ...
        let transformValue = startTransform - (scrollY/7 );
            ...
            <div className="recent_work_list">
                <ul className='recent__work__container'>
                    <li className='recent__work__item'>
                        <img className="work__image" src={savore} alt="render website image"/>
                        <div className='recent__header'>Savore</div>
                        <div>Design & Development</div>
                        <div className='tech'>
                            <div className='tech__bubble'>React</div>
                            <div className='tech__bubble'>Javascript</div>
                            <div className='tech__bubble'>Jest</div>
                            <div className='tech__bubble'>...</div>
                        </div>
                    </li>
                    <li className='recent__work__item'>
                        <img className="work__image" src={barhop} alt="render website image"/>
                        <div className='recent__header'>Barhop</div>
                        <div>Design & Development</div>
                        <div className='tech'>
                            <div className='tech__bubble'>Ruby on Rails</div>
                            <div className='tech__bubble'>Javascript</div>
                            <div className='tech__bubble'>Git</div>
                            <div className='tech__bubble'>...</div>
                        </div>
                    </li>
                    <li className='recent__work__item'>
                        <img className="work__image" src={render} alt="render website image"/>
                        <div className='recent__header'>Render</div>
                        <div>Design & Development</div>
                        <div className='tech'>
                            <div className='tech__bubble'>Ruby on Rails</div>
                            <div className='tech__bubble'>Javascript</div>
                            <div className='tech__bubble'>CSS</div>
                            <div className='tech__bubble'>...</div>
                        </div>
                    </li>
                </ul>
